   ...
   public class clsMitarbeiterDaten 
    {
        ...
        {
            return clsMitarbeiterDatenZugriff.GetMitarbeiter_View();
        }
        public static DataTable GetMitarbeiterByPersonVollname(string vollname)
        {
            return clsMitarbeiterDatenZugriff.GetMitarbeiterByPersonName(vollname);
        }
    }
}
