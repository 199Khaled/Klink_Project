...
namespace Kliniken
{
    public partial class frmAktualiserenUndNeuenArbeitsvertragHinzufügen : Form
    {
        ...
        {
            int vergütungID = clsVergütungDaten.GetVergütungID(cbVergütung.SelectedItem as string);
            frmVergütungDetails frm = new frmVergütungDetails(vergütungID);
            frm.ShowDialog();
            frm.Dispose();
        }
        ...
        {
            int arbeitszeitID = clsArbeitszeitDaten.GetArbeitszeitID(cbArbeitszeit.SelectedItem as string);
            frmArbeitszeitDetails frm = new frmArbeitszeitDetails(arbeitszeitID);
            frm.ShowDialog();
            frm.Dispose();
        }
        ...
        {
            int abteilungID = clsAbteilungDaten.GetAbteilungID(cbAbteilung.SelectedItem as string);
            frmAbteilungDetails frm = new frmAbteilungDetails(abteilungID);
            frm.ShowDialog();
            frm.Dispose();
        }
    }
